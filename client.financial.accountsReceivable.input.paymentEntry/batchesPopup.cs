...
namespace client.financial.accountsReceivable.input.paymentEntry
{
    public partial class batchesPopup : Form
    {
        ...
        public batchesPopup(client.financial.accountsReceivable.input.paymentEntry.Form1 inParentForm, String inBatNbr)
        {
            InitializeComponent();
            parentForm = inParentForm;
            this.gvBatches.DataSource = parentForm.myPEObj.getBatchesByBatNbr(inBatNbr);
        }
