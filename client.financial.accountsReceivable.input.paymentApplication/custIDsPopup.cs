...
namespace client.financial.accountsReceivable.input.paymentApplication
{
    public partial class custIDsPopup : Form
    {
        ...
        public custIDsPopup(client.financial.accountsReceivable.input.paymentApplication.Form1 inParentForm, String inCustID)
        {
            InitializeComponent();
            ...
            this.gvCustIDs.DataSource = parentForm.myPAObj.getCustomersByCustID(tmpCustID);
        }
